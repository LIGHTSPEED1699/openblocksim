...
describe('history helpers', () => {
  ...
  it('pushEntry appends an entry and returns a new array', () => {
    const d0: DiagramDoc = { nodes: [], edges: [], params: {}, groups: [] };
  ...
  it('pushEntry caps the stack at the limit, dropping the oldest entries', () => {
    ...
    for (let i = 0; i < 5; i++) {
      const before: DiagramDoc = { nodes: [], edges: [], params: { g: { k: i } }, groups: [] };
      const after: DiagramDoc = { nodes: [], edges: [], params: { g: { k: i + 1 } }, groups: [] };
  ...
  it('exports HISTORY_LIMIT = 100 used as the default cap', () => {
    ...
    const before: DiagramDoc = { nodes: [], edges: [], params: {}, groups: [] };
    const after: DiagramDoc = { nodes: [], edges: [], params: { g: { k: 1 } }, groups: [] };
